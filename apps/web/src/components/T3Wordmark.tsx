...
// The Hotlap mark (assets/hotlap/mark.svg) flattened to a single colour.
export function T3Wordmark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="5.26 8.78 85.5 85.5" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="currentColor"
      />
      <circle cx="80.5" cy="29.5" r="3.3" fill="currentColor" />
    </svg>
  );
}
